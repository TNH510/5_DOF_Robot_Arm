...
set_param('Assem1/Slider Gain','Gain',num2str(theta1));
set_param('Assem1/Slider Gain1','Gain',num2str(theta2));
set_param('Assem1/Slider Gain2','Gain',num2str(theta3));
set_param('Assem1/Slider Gain3','Gain',num2str(theta4));
set_param('Assem1/Slider Gain4','Gain',num2str(theta5));
...
T2=[cosd(theta2) -sind(theta2) 0  l2*cosd(theta2); 
    sind(theta2) cosd(theta2)  0  l2*cosd(theta2);
    0            0             1              0;
    0            0             0              1];
T3=[cosd(theta3) -sind(theta3) 0  l3*cosd(theta3); 
    sind(theta3) cosd(theta3)  0  l3*cosd(theta3);
    0            0             1              0;
    0            0             0              1];
T4=[-sind(theta4) 0            cosd(theta4)   0; 
    cosd(theta4)  0            sind(theta4)   0;
    0            1             0              0;
    0            0             0              1];
T5=[cosd(theta5) -sind(theta5) 0              0; 
...
theta3=atan2d((m^2+n^2-l1^2-l2^2)/(2*l3*l2),sqrt(1-(cosd(theta3))^2));
A= m1*(l3*cosd(theta3)+l2)+n1*(l3*sind(theta3));
B= n1*(l3*cosd(theta3)+l2)-m1*(l3*sind(theta3));
theta2=atan2d(B,A);
...
set_param('Assem1/Slider Gain' ,'Gain',theta1);
set_param('Assem1/Slider Gain1','Gain',theta2);
set_param('Assem1/Slider Gain2','Gain',theta3);
set_param('Assem1/Slider Gain3','Gain',theta4);
