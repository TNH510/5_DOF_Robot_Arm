...
SAMPLE_FREQ = 8  # Frequency to record magnetometer readings at [Hz]
T_SAMPLE = 40  # Total time to read mangetometer readings [sec]
OUTPUT_FILENAME = 'mag-readings-1.txt'  # Output data file name
...
class PlotPoints3D:
    ...
    def __init__(self, fig, ax, live_plot=True, marker='o', c='r'):
        ...
        self.ax.set_xlim((-1000, 1000))  # Set axes limits to keep plot shape
