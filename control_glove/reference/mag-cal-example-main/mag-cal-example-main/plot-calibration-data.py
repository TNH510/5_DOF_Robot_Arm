...
A = np.array(   [[0.857760, -0.041265, -0.002298],
                [-0.041265, 0.902960, 0.067499],
                [-0.002298, 0.067499, 0.098554]])
b = np.array([-23.825696, -32.423035, 4.125466])


# Read raw data and apply calibration
rawData = np.genfromtxt('mag-readings-1.txt', delimiter='\t')  # Read raw measurements
