...
/* Public variables --------------------------------------------------------- */
/* Private variables -------------------------------------------------------- */
static float A[3][3] = {{0.779461f, 0.008545f, -0.002906f}, 
                        {0.008545f, 0.819412f, -0.018728f}, 
                        {0.002906f, -0.018728f, 0.963059f}};

static float b[3] = {129.605404f, -251.437191f, -24.113506f};
