...
Px = cos(t1)*(- l78*sin(t3 - t2 - t4) + l3*cos(t2) + l5*cos(t3 - t2)) - (l6 + l42)*sin(t1)
Py = sin(t1)*(- l78*sin(t3 - t2 - t4) + l3*cos(t2) + l5*cos(t3 - t2)) + (l6 + l42)*cos(t1)
Pz = l1 + l3*sin(t2) - l78*cos(t3 - t2 - t4) - l5*sin(t3 - t2)