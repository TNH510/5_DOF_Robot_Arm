...
data = csvread('outputPath.csv', 0, 1); % 'file.csv' là tên tệp CSV, 0 là số dòng bắt đầu (0 nếu không có dòng tiêu đ�?), 1 là số cột (cột thứ 2)
time = data(:, 1)
t1_array = data(:, 2)
t2_array = data(:, 3)
t3_array = data(:, 4)
...
filename = 'outputPath_result.csv';
fileID = fopen(filename, 'a');

for i = 1:1:773

     t1 = t1_array(i) * pi / 180 %rad
     t2 = t2_array(i) * pi / 180
     t3 = t3_array(i) * pi / 180
     t4 = t4_array(i) * pi / 180
     t5 = t5_array(i) * pi / 180
     ...
     *cos(t2 + t3)*lc2*cos(t1)*(lc3*cos(t2 + t3) + l2*cos(t2)))/2 + ...
     ...
     fprintf(fileID, '%f,%f,%f,%f,%f,%f\n', i, tau(1), tau(2), tau(3), tau(4), tau(5));
     % MOMENT PLOT
